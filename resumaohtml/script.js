...
function iconeManager3() {
    titulo.innerHTML = "Sobre <strong>HTML/CSS";
    faixa.src = "img/codigo.png";
...
function iconeManager5() {
    ...
    faixa.src = "img/font.jpg";
    texto.innerHTML = "<p>Para chamar uma fonte específica que já está instalada no seu computador, utilizamos a propriedade font-family no arquivo CSS, na classe onde deseja que ela seja colocada. Ainda no arquivo CSS você pode chamar um asterisco (*) para dizer que aquilo pode ser aplicado em todo o site. Caso a fonte não esteja instalada, sugerimos que você procure uma fonte no <a href='https://fonts.google.com/' class='interno'>GoogleFonts</a>. Lá, você poderá selecionar a fonte que mais gostar e pode simplesmente colar o código que o site gera em seu HTML.</p>";
}
